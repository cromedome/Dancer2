...
You are not limited to writing configuration files in YAML.
...
=head2 Specifying additional configuration files
...
living in your application's version control repository.
